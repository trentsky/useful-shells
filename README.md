:scream: 本仓库已废弃！迁移到 [useful-scripts](https://github.com/oldratlee/useful-scripts)
==========================

.

:scream_cat: This repo is deprecated! moved to [useful-scripts](https://github.com/oldratlee/useful-scripts)
==========================
